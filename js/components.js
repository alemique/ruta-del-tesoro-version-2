// Este archivo crea una única variable global, GAME_COMPONENTS,
// que contendrá todos los componentes de React de nuestra aplicación.
// Así, app.js puede encontrarlos y usarlos sin problemas.

const GAME_COMPONENTS = (function() {
    ...
    // Hacemos que los componentes sean públicamente accesibles
    return {
        Header,
        LoginPage
    };
